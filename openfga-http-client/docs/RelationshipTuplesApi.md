...
> models::ReadResponse read(store_id, body)
...
> models::ReadChangesResponse read_changes(store_id, r#type, page_size, continuation_token, start_time)
...
**start_time** | Option<**String**> | Start date and time of changes to read. Format: ISO 8601 timestamp (e.g., 2022-01-01T00:00:00Z) If a continuation_token is provided along side start_time, the continuation_token will take precedence over start_time. |  |

### Return type

[**models::ReadChangesResponse**](ReadChangesResponse.md)
